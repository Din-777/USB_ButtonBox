 ...
 * the implications!
 */
#define  USB_CFG_DEVICE_ID       0xdb, 0x27 /* obdev's shared PID for HID Keyboard */
 ...
 */
#define USB_CFG_VENDOR_NAME      'o', 'b', 'r', 'u', 'b', 'o', 'f','f', '.', 'r', 'u'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'V', 'o', 'l', 'u', 'm', 'e', ' ', 'c', 'o', 'n', 't', 'r', 'o', 'l'
